...
class HttpResponse : public HttpMessage {
 ...
 public:
    ...
    /// This argument can be omitted if the code is standard (listed in RFC
    /// 7231). In that case, the reason phrase suggested in RFC 7231 will be
    /// used. If a non standard code is used and reasonPhrase is empty, the
    /// method will reject the status code and return false;
    ...
    /// Build the status line, e.g: "HTTP/1.1 200 OK" or "HTTP/1.0 404 Not
    /// found" Text is built from values of the member attributes of this object
 ...
 protected:
    ...
    /// there are already in the headers associative array. It tries to get
    /// these values by looking at the body object
